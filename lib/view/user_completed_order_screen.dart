...
class UserCompletedOrderScreen extends StatefulWidget {
  ...
  @override
  State<UserCompletedOrderScreen> createState() =>
      _UserCompletedOrderScreenState();
}

class _UserCompletedOrderScreenState extends State<UserCompletedOrderScreen> {
  ...
  void initState() {
    ...
    userOrdersViewModel.fetchUserCompletedVideoList();
  }
    ...
    return Scaffold(
      body: ChangeNotifierProvider(
        ...
        child:
          ...
          return Column(
            children: [
              if (viewModel.isCompletedOrderFetching &&
              ...
              else if (!viewModel.isCompletedOrderFetching &&
                  viewModel.completedOrders.isEmpty)
                Expanded(
                  child: Center(
                    child: Column(
                  ...
                  child: NotificationListener<ScrollNotification>(
                    onNotification: (ScrollNotification scrollInfo) {
                      if (scrollInfo.metrics.pixels ==
                          ...
                          !viewModel.isCompletedOrderFetching &&
                          viewModel.hasCompletedOrdersMoreData) {
                        viewModel.fetchUserCompletedVideoList();
                        return true;
                      }
                      return false;
                    },
                    child: Padding(
                      ...
                      child: ListView.builder(
                        itemCount: viewModel.completedOrders.length +
                            (viewModel.isCompletedOrderFetching ? 1 : 0),
                        itemBuilder: (context, index) {
                          if (index == viewModel.completedOrders.length) {
                            return const Center(
                              child: Padding(
                          ...
                          final influencer = viewModel.completedOrders[index];
                          return Padding(
          ...
          // switch (value.userCompletedOrderList.status) {
          //   case Status.INIT:
          //     return Container();
          //   case Status.LOADING:
          ...
          //     return Center(
          //       child: Content(
          //           data: value.userCompletedOrderList.message.toString(),
          //           size: 18),
          //     );
          //   case Status.COMPLETED:
          //     return value.userCompletedOrderList!.data!.result!.data!
          //                 .length ==
          //             0
          //         ? Expanded(
          //             child: Column(
