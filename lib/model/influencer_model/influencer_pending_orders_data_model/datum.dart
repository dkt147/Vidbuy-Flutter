...
class InfluencerPendingOrdersDatum {
  int? id;
  int? userId;
  int? influencerId;
  String? videoFor;
  ...
  factory InfluencerPendingOrdersDatum.fromJson(Map<String, dynamic> json) =>
      InfluencerPendingOrdersDatum(
        id: json['id'] as int?,
  ...
  bool operator ==(Object other) {
    ...
    if (other is! InfluencerPendingOrdersDatum) return false;
