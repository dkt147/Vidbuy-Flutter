...
class CompletedOrdersDatum {
  ...
  factory CompletedOrdersDatum.fromJson(Map<String, dynamic> json) =>
      CompletedOrdersDatum(
        id: json['id'] as int?,
  ...
  bool operator ==(Object other) {
    ...
    if (other is! CompletedOrdersDatum) return false;
